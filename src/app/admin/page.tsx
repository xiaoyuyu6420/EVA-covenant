...
function channelLabel(channel: string | null) {
  const labels: Record<string, string> = {
    ...
    quick_invite_copy: "快捷默认邀请",
    quick_target_invite_copy: "快捷定向邀请",
    quick_invite_native: "快捷默认系统分享",
    quick_target_invite_native: "快捷定向系统分享",
    quick_invite_fallback: "快捷默认复制兜底",
    quick_target_invite_fallback: "快捷定向复制兜底",
    return_copy: "回传上游",
